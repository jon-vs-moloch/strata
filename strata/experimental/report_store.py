...
def persist_experiment_report(
    ...
    *,
    ...
    variant_rating_snapshot: Optional[Dict[str, Any]] = None,
    ab_evidence_summary: Optional[Dict[str, Any]] = None,
    ...
    report_payload = {
        ...
        "variant_assignment": variant_assignment or {},
        "variant_rating_snapshot": variant_rating_snapshot or {},
        "ab_evidence_summary": ab_evidence_summary or {},
