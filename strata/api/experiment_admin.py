    ...
    *,
    ...
    async def run_bootstrap_cycle(payload: Dict[str, Any] | None = None, storage=Depends(get_storage)):
        ...
        for proposal in proposals:
            ...
            evaluated.append({"proposal": proposal_to_evaluate, "result": result.model_dump(), "resolution": resolution})
            if auto_promote and result.recommendation == "promote":
                promoted.append(apply_experiment_promotion(storage, proposal_to_evaluate["candidate_change_id"], force=False))
