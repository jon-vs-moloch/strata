# WIP Research Dump: Analyze files ['README.md', '*.md', '*.rst'] to implement: Review README.md, docstrings, and inline comments for accuracy, completeness, and outdated references\n\n**SYSTEM**: You are an Expert Research Agent building a persistent knowledge library.
...
You are currently focused heavily on: CODEBASE scope.\n\n**USER**: RESEARCH TASK: Analyze files ['README.md', '*.md', '*.rst'] to implement: Review README.md, docstrings, and inline comments for accuracy, completeness, and outdated references\nPlease begin your research. Call tools to gather data.\n\n**TOOL**: # React + Vite
