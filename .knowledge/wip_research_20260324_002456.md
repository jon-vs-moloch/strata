# WIP Research Dump: Analyze files ['./**/*.py', './**/__init__.py'] to implement: Scan the repository for all Python files to identify candidates for code review and maintenance tasks. Categorize by type (logic, config, tests)\n\n**SYSTEM**: You are an Expert Research Agent building a persistent knowledge library.
...
You are currently focused heavily on: CODEBASE scope.\n\n**USER**: RESEARCH TASK: Analyze files ['./**/*.py', './**/__init__.py'] to implement: Scan the repository for all Python files to identify candidates for code review and maintenance tasks. Categorize by type (logic, config, tests)\nPlease begin your research. Call tools to gather data.\n\n**TOOL**: # React + Vite
